...
class SubscriptionsServiceProvider extends ServiceProvider
{
    ...
    {
        // Publish Resources
        $this->publishesConfig('antanas/laravel-subscription-system');
        $this->publishesMigrations('antanas/laravel-subscription-system');
        ! $this->autoloadMigrations('antanas.subscriptions') || $this->loadMigrationsFrom(__DIR__.'/../../database/migrations');
    }
}
